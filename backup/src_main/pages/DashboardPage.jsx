...
const DashboardPage = () => {
  ...
  return (
    <div>
      ...
      {activeWalk ? (
        <div className="mb-8">
          <div className="flex justify-between items-center mb-3">
            <h2 className="text-xl font-semibold text-gray-800">Actieve wandeling</h2>
            <Link 
        ...
        <div className="mb-8 bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-3">Start een nieuwe wandeling</h2>
      ...
      <div>
        <div className="flex justify-between items-center mb-3">
          <h2 className="text-xl font-semibold text-gray-800">Recente wandelingen</h2>
          <Link 
            to="/walks"
            className="text-blue-600 hover:text-blue-800"
          >

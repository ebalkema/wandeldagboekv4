      ...
      <div className="p-3 sm:p-4">
        ...
        <div className="mt-2 sm:mt-3 flex flex-wrap items-center text-xs sm:text-sm gap-y-1">
          <div className="flex items-center mr-3 sm:mr-4">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 sm:h-4 sm:w-4 text-gray-500 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        {isActive && (
          <div className="mt-2 sm:mt-3 flex justify-end">
            <span className="inline-flex items-center px-2 sm:px-2.5 py-0.5 rounded-full text-xs font-medium bg-green-100 text-green-800">
              <span className="w-1.5 h-1.5 sm:w-2 sm:h-2 mr-1 bg-green-500 rounded-full animate-pulse"></span>
              Actief
            </span>
          </div>
        )}
